...
function CoinDetailChart({ coin, onRefresh }) {
  ...
  const renderQualityTag = () => {
    ...
    const qualityExplanations = {
      '高质量进场': '相邻关键节点间场外指数稳步上升，主力持续加仓，波动有望充分展开。',
      '低质量进场': '相邻关键节点间场外指数蜿蜒反复，大资金对投产比不明确易抽身，进场期可能变差变短。',
      '低质量进场期（需调仓）': '进场期一周内未破200且爆破指数均值下降，主力动能不足，建议调整仓位。',
      '进场期 (待观察)': '当前进场期尚未出现爆破指数跌破200的关键节点，暂无法评估质量。',
      '高质量退场': '相邻关键节点间场外指数稳步下降，主力撤离明显，做空性价比高。',
      '低质量退场': '相邻关键节点间场外指数出现反复，主力撤离不明显，退场期做空需谨慎。',
